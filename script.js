...
const RESOURCES = [
    ...
    },
    {
        ...
        category: 'tools',
        icon: '📈',
        title: 'daily_stock_analysis — Analyse boursière LLM',
        description: 'Système open-source pour analyser les marchés A/H/US avec données marché, news en temps réel, raisonnement LLM et dashboard de décision. Très utile pour une veille financière automatisée et zéro-cost runtime.',
        tags: ['stocks', 'llm', 'finance', 'automation'],
        type: 'tool',
    ...
    },
    {
        ...
        category: 'tools',
        icon: '📓',
        title: 'notebooklm-py — API Python NotebookLM',
        description: 'API Python non officielle pour NotebookLM avec accès programmatique, CLI et usage agentique. Permet d\'automatiser des workflows NotebookLM au-delà de l\'interface web standard.',
        tags: ['python', 'notebooklm', 'api', 'agents'],
        type: 'tool',
    ...
    },
    {
        ...
        category: 'frameworks',
        icon: '🤝',
        title: 'collab-public — Création collaborative avec agents',
        description: 'Plateforme pour construire avec des agents IA de manière collaborative. Orchestration de sessions, itération produit, et génération de livrables en équipe.',
        tags: ['collaboration', 'multi-agent', 'platform'],
        type: 'framework',
        link: 'https://github.com/collaborator-ai/collab-public',
        code: null
    },
    {
        id: 54,
        category: 'skills',
        icon: '🧰',
        title: 'claude-skills — 200+ skills/plugins cross-agent',
        description: 'Collection massive de skills et plugins pour Claude Code, Codex, Gemini CLI, Cursor et autres agents. Couvre engineering, product, marketing, compliance et workflows C-level.',
        tags: ['skills', 'plugins', 'cross-agent', 'collection'],
        type: 'skill',
    ...
    },
    {
        ...
        category: 'frameworks',
        icon: '🎯',
        title: 'career-ops — Système agentique de recherche d\'emploi',
        description: 'Command center job-search construit pour Claude Code: scoring structuré des offres, génération de CV PDF ATS, scan de portails (Greenhouse/Ashby/Lever), batch processing, dashboard TUI Go et pipeline de suivi. Positionnement clair: filtrer intelligemment, pas spammer les candidatures.',
        tags: ['job-search', 'career', 'claude-code', 'pipeline', 'ats'],
        type: 'framework',
        link: 'https://github.com/santifer/career-ops',
        code: '/career-ops scan\n/career-ops batch\n/career-ops pdf\n/career-ops tracker'
    },
    {
        id: 56,
        category: 'tools',
        ...
        description: 'Agent orienté candidatures qui automatise la collecte d\'offres, l\'adaptation de profil et les actions répétitives du funnel emploi. À utiliser avec supervision humaine pour garder qualité et ciblage.',
        tags: ['job-search', 'automation', 'agent', 'career'],
        type: 'tool',
    ...
    },
    {
        ...
        category: 'tools',
        icon: '🧭',
        title: 'job-ops — Ops toolkit pour candidatures',
        description: 'Boîte à outils open-source orientée opérations de recherche d\'emploi: suivi, standardisation du process, et automatisation des tâches répétitives.',
        tags: ['job-search', 'ops', 'workflow', 'career'],
        type: 'tool',
        link: 'https://github.com/DaKheera47/job-ops',
        code: null
    },
    {
        id: 58,
        ...
        description: 'Moteur de swarm intelligence orienté prédiction et optimisation multi-agent. Positionné comme un noyau universel pour résoudre des problèmes de recherche exploratoire.',
        tags: ['swarm', 'prediction', 'ai-engine'],
        type: 'framework',
    ...
    },
    {
        ...
        category: 'frameworks',
        icon: '🐍',
        title: 'ouroboros — Agent auto-créatif',
        description: 'Projet expérimental d\'agent qui s\'auto-structure et itère sur son propre fonctionnement. Intéressant pour explorer les patterns d\'autonomie longue durée.',
        tags: ['autonomous-agent', 'research', 'experimental'],
        type: 'framework',
    ...
    },
    {
        ...
        category: 'tools',
        icon: '✂️',
        title: 'snip — Réduction tokens 60-90%',
        description: 'CLI proxy en Go pour compacter les sorties d\'agents (Claude Code, Cursor, Copilot, Gemini). Alternative RTK avec filtres YAML déclaratifs pour réduire les coûts de contexte.',
        tags: ['tokens', 'proxy', 'cli', 'optimization'],
        type: 'tool',
        link: 'https://github.com/edouard-claude/snip',
        code: null
    },
    {
        id: 61,
        category: 'frameworks',
        icon: '🦀',
        title: 'zeroclaw — Infra assistant autonome',
        description: 'Infrastructure d\'assistant personnel autonome, cross-platform, orientée performance et portabilité. Pensé pour déploiements flexibles et composants interchangeables.',
        tags: ['assistant', 'rust', 'autonomous', 'infrastructure'],
        type: 'framework',
    ...
    },
    {
        ...
        category: 'tools',
        icon: '🛡️',
        title: 'shannon — Pentest autonome white-box',
        description: 'Pentester IA pour applications web et APIs: analyse du code source, identification des vecteurs d\'attaque, exécution de preuves d\'exploitation pour valider les vulnérabilités.',
        tags: ['security', 'pentest', 'api', 'autonomous'],
        type: 'tool',
    ...
    },
    {
        ...
        category: 'frameworks',
        icon: '🧠',
        title: 'opencode — Coding agent open-source',
        description: 'Agent de développement open-source orienté productivité, exécution d\'actions code-first et workflows de livraison accélérés.',
        tags: ['coding-agent', 'open-source', 'development'],
        type: 'framework',
    ...
    },
    {
        ...
        category: 'tools',
        icon: '🧱',
        title: 'awesome-mcp-servers — Répertoire MCP',
        description: 'Liste curatée de serveurs MCP pour connecter vos agents à des APIs, datasets, services métier et outils d\'entreprise.',
        tags: ['mcp', 'awesome-list', 'integrations'],
        type: 'tool',
    ...
    },
    {
        ...
        category: 'tools',
        icon: '🇫🇷',
        title: 'mcp-vosdroits — MCP Service-Public',
        description: 'Serveur MCP dédié au service public Vos Droits. Permet des intégrations agentiques sur des données et workflows administratifs français.',
        tags: ['mcp', 'france', 'public-data', 'service-public'],
        type: 'tool',
        link: 'https://github.com/guigui42/mcp-vosdroits',
        code: null
    },
    {
        id: 66,
        category: 'skills',
        icon: '🧠',
        title: 'everything-claude-code — Harness complet',
        description: 'Système de performance pour agents: skills, memory, security, recherche-first et standards d\'exécution pour Claude Code, Codex, Cursor et autres.',
        tags: ['claude-code', 'skills', 'memory', 'security'],
        type: 'skill',
    ...
    },
    {
        ...
        category: 'frameworks',
        icon: '🦌',
        title: 'deer-flow — SuperAgent long-horizon',
        description: 'Harness agentique long-horizon avec sandbox, mémoire, tools, skills et sous-agents. Conçu pour recherche, création et exécution multi-étapes.',
        tags: ['superagent', 'long-horizon', 'orchestration'],
        type: 'framework',
    ...
    },
    {
        ...
        category: 'frameworks',
        icon: '⚙️',
        title: 'claw-code — Harness Rust haute vitesse',
        description: 'Framework agentique Rust orienté exécution rapide, équipes d\'agents et workflow intensif. Positionné pour des usages code-first à gros volume.',
        tags: ['rust', 'agent-harness', 'performance'],
        type: 'framework',
    ...
    },
    {
        ...
        category: 'tools',
        icon: '📱',
        title: 'companion — UI web/mobile pour agents',
        description: 'Interface web et mobile pour lancer des sessions Claude Code/Codex, suivre le streaming et approuver les outils depuis le navigateur.',
        tags: ['ui', 'mobile', 'claude-code', 'codex'],
        type: 'tool',
        link: 'https://github.com/The-Vibe-Company/companion',
        code: null
    },
    {
        id: 70,
        category: 'skills',
        icon: '🏢',
        title: 'agency-agents — Équipe IA prête à l\'emploi',
        description: 'Collection d\'agents spécialisés avec processus, personnalité et responsabilités claires: frontend, growth, communauté, QA et rôle de challenge.',
        tags: ['agents', 'team', 'playbook', 'specialists'],
        type: 'skill',
    ...
    },
    {
        ...
        category: 'frameworks',
        icon: '🧠',
        title: 'OpenViking — Context DB pour agents',
        description: 'Base de contexte open-source pour agents (mémoire, ressources, skills). Centralise et versionne la connaissance nécessaire à des agents persistants.',
        tags: ['context-db', 'memory', 'skills', 'agents'],
        type: 'framework',
    ...
    },
    {
        ...
        category: 'tools',
        icon: '🕸️',
        title: 'Understand-Anything — Knowledge graph interactif',
        description: 'Transforme codebase ou base documentaire en graphe de connaissances interrogeable. Aide à explorer et comprendre rapidement des systèmes complexes.',
        tags: ['knowledge-graph', 'learning', 'visualization'],
        type: 'tool',
    ...
    },
    {
        ...
        description: 'Proxy CLI pour compacter les sorties de commandes et réduire les coûts de tokens. Très efficace sur tests, lint/build et commandes git volumineuses.',
        tags: ['tokens', 'cli', 'rust', 'optimization'],
        type: 'tool',
    ...
    },
    {
        ...
        category: 'skills',
        icon: '🪨',
        title: 'caveman — Skill anti-gaspillage tokens',
        description: 'Skill qui force une communication ultra-compacte pour réduire fortement la consommation de tokens lors des échanges avec des agents de code.',
        tags: ['tokens', 'skill', 'cost-control'],
        type: 'skill',
    ...
    },
    {
        ...
        category: 'skills',
        icon: '🎨',
        title: 'awesome-design-md — Design systems en fichiers MD',
        description: 'Collection de DESIGN.md inspirés de grandes marques. Copier un fichier à la racine aide un agent à produire une UI cohérente avec un langage visuel précis.',
        tags: ['design', 'design-system', 'ui', 'markdown'],
        type: 'skill',
    ...
    },
    {
        ...
        category: 'tools',
        icon: '🕸️',
        title: 'code-review-graph — Graphe local de codebase',
        description: 'Construit une carte persistante du code pour limiter les lectures inutiles. Réduit les tokens sur reviews et accélère le raisonnement contextuel.',
        tags: ['code-review', 'knowledge-graph', 'tokens'],
        type: 'tool',
    ...
    },
    {
        ...
        category: 'frameworks',
        icon: '🧪',
        title: 'feynman — Agent companion framework',
        description: 'Projet orienté exécution assistée et orchestration d\'agents, avec un focus sur des boucles d\'apprentissage et d\'itération rapide.',
        tags: ['agent', 'framework', 'iteration'],
        type: 'framework',
    ...
    },
    {
        ...
        category: 'frameworks',
        icon: '👥',
        title: 'oh-my-claudecode — Orchestration multi-agent teams-first',
        description: 'Framework axé équipes pour orchestrer plusieurs agents Claude Code en parallèle avec coordination et distribution du travail.',
        tags: ['multi-agent', 'claude-code', 'teams'],
        type: 'framework',
    ...
    },
    {
        ...
        category: 'tools',
        icon: '📝',
        title: 'markitdown — Conversion fichiers vers Markdown',
        description: 'Outil Python Microsoft pour convertir documents Office et nombreux formats de fichiers vers Markdown exploitable par les agents.',
        tags: ['markdown', 'conversion', 'python', 'documents'],
        type: 'tool',
    ...
    },
    {
        ...
        category: 'tools',
        icon: '🖱️',
        title: 'page-agent — Agent in-page GUI',
        description: 'Agent JavaScript qui contrôle une interface web depuis la page elle-même via langage naturel, utile pour automatiser des interactions GUI.',
        tags: ['browser', 'gui', 'automation', 'javascript'],
        type: 'tool',
    ...
    },
    {
        ...
        category: 'frameworks',
        icon: '🧬',
        title: 'hermes-agent — Agent qui apprend dans le temps',
        description: 'Agent de NousResearch conçu pour évoluer avec vos usages et apprendre de ses erreurs. Intéressant pour workflows persistance + amélioration continue.',
        tags: ['agent', 'learning', 'autonomous', 'nousresearch'],
        type: 'framework',
    ...
    },
    {
        ...
        category: 'frameworks',
        icon: '🧑‍💻',
        title: 'oh-my-openagent — Harness openagent',
        description: 'Harness multi-agent orienté vitesse d\'exécution et coordination de workflows de code, successeur de oh-my-opencode.',
        tags: ['openagent', 'harness', 'multi-agent'],
        type: 'framework',
    ...
    },
    {
        ...
        category: 'tools',
        icon: '🦊',
        title: 'camofox-browser — Browser automation anti-blocage',
        description: 'Serveur headless de browser automation conçu pour aider les agents à accéder aux sites souvent bloqués par des protections anti-bot.',
        tags: ['browser', 'automation', 'headless', 'anti-bot'],
        type: 'tool',
    ...
    },
    {
        ...
        category: 'skills',
        icon: '🧑‍🎨',
        title: 'awesome-design-systems — Répertoire design systems',
        description: 'Collection large de design systems à étudier pour inspirer des interfaces cohérentes, avec patterns visuels et règles de composition éprouvées.',
    ...
    },
    {
        ...
        category: 'frameworks',
        icon: '🧪',
        title: 'pi-autoresearch — Boucle autonome d\'expériences',
        description: 'Extension d\'expérimentation autonome: modifie le code, mesure, conserve les gains, rejette les régressions et recommence. Idéal pour optimisation perf continue.',
        tags: ['autoresearch', 'performance', 'experiments'],
        type: 'framework',
    ...
    },
    {
        ...
        category: 'skills',
        icon: '📐',
        title: 'andrej-karpathy-skills — CLAUDE.md guidé',
        description: 'Guidelines prêtes à l\'emploi pour éviter les écueils LLM: hypothèses cachées, sur-ingénierie, changements hors-scope et manque de critères de succès.',
        tags: ['claude-md', 'guidelines', 'quality'],
        type: 'skill',
    ...
    },
    {
        ...
        category: 'tools',
        icon: '📉',
        title: 'nothing-ever-happens — Bot strategy Polymarket',
        description: 'Bot qui automatise une stratégie spécifique sur marchés de prédiction (orientation "No"). Cas d\'étude intéressant pour automation financière et exécution disciplinée.',
    ...
    },
    {
        ...
        category: 'local-ai',
        icon: '📊',
        title: 'Kronos — Foundation model marchés financiers',
        description: 'Modèle pré-entraîné orienté séries financières/candlesticks (forecast prix/volatilité, zero-shot). Projet académique open-source à fort potentiel appliqué.',
        tags: ['finance', 'timeseries', 'foundation-model'],
        type: 'model',
    ...
    },
    {
        ...
        category: 'skills',
        icon: '🧩',
        title: 'autoskills — Installation auto de skill stack',
        description: 'CLI qui scanne votre projet, détecte la stack et installe automatiquement les skills pertinents depuis skills.sh. Génère aussi un résumé CLAUDE.md.',
        tags: ['skills', 'automation', 'scaffolding', 'cli'],
        type: 'tool',
    ...
    },
    {
        ...
        category: 'tools',
        icon: '🧳',
        title: 'TREK — Travel planner self-hosted',
        description: 'Planificateur de voyage self-hosted avec cartes interactives, collaboration temps réel, budget, checklists bagages, PWA et SSO.',
        tags: ['self-hosted', 'planner', 'collaboration'],
        type: 'tool',
    ...
    },
    {
        ...
        category: 'tools',
        icon: '🇫🇷',
        title: 'datagouv-mcp — MCP data.gouv.fr',
        description: 'Serveur MCP expérimental pour interroger les données de data.gouv.fr via agent IA. Idéal pour réutilisation de métadonnées publiques françaises.',
        tags: ['mcp', 'data-gouv', 'open-data', 'france'],
        type: 'tool',
        link: 'https://github.com/datagouv/datagouv-mcp',
        code: null
    },
    {
        id: 92,
        category: 'tools',
        icon: '🛍️',
        title: 'Shopify AI Toolkit — Agent-commerce toolkit',
        description: 'Toolkit officiel Shopify pour connecter des agents (Claude Code, Codex, VS Code, etc.) aux opérations de gestion de store.',
        tags: ['shopify', 'toolkit', 'agents', 'ecommerce'],
        type: 'tool',
        link: 'https://shopify.dev/docs/apps/build/ai-toolkit',
        code: null
    },
    {
        id: 93,
        category: 'tools',
        icon: '☁️',
        title: 'Windsurf 2.0 — Agent Command Center',
        description: 'Vue Kanban pour piloter agents locaux et cloud, avec espaces projet et délégation cloud (Devin) pour poursuivre les tâches même hors-ligne utilisateur.',
        tags: ['agents', 'command-center', 'cloud', 'productivity'],
        type: 'tool',
        link: 'https://windsurf.com/blog/windsurf-2-0',
        code: null
    },
    {
        id: 94,
        category: 'tools',
        icon: '📚',
        title: 'Code Wiki (Google) — Analyse rapide de repo',
        description: 'Service pour obtenir rapidement architecture, choix techniques et synthèse d\'un repo avant de challenger les décisions avec un agent de code.',
        tags: ['analysis', 'repository', 'documentation'],
        type: 'tool',
    ...
    },
    {
        ...
        category: 'local-ai',
        icon: '⏳',
        title: 'TimesFM — Forecasting séries temporelles',
        description: 'Modèle de Google Research pour prévision de séries temporelles (prix, trafic, météo, etc.) avec une approche foundation model dédiée.',
        tags: ['timeseries', 'forecasting', 'google-research'],
        type: 'model',
    ...
    },
    {
        ...
        category: 'local-ai',
        icon: '📱',
        title: 'google-ai-edge/gallery — IA locale sur mobile',
        description: 'Galerie de démos IA edge/mobile (dont Gemma) pour exécuter des expériences directement sur appareil sans dépendre du cloud.',
        tags: ['mobile', 'edge-ai', 'gemma', 'google'],
        type: 'tool',
    ...
    },
    {
        ...
        category: 'tools',
        icon: '📰',
        title: 'Article data.gouv.fr — Expérimentation MCP',
        description: 'Article de présentation de l\'expérimentation du serveur MCP data.gouv.fr, usage attendu et retours demandés par l\'équipe.',
        tags: ['mcp', 'open-data', 'article', 'france'],
        type: 'guide',
        link: 'https://data.gouv.fr/posts/experimentation-autour-dun-serveur-mcp-pour-datagouv',
        code: null
    },
    {
        id: 98,
        category: 'tools',
        icon: '🧾',
        title: 'Paperasse Skills IA — Fiscalité FR',
        description: 'Pack de skills orienté comptabilité/fiscalité française, avec accès à des ressources de référence adaptées aux cas administratifs nationaux.',
        tags: ['skills', 'fiscalite', 'france', 'administratif'],
        type: 'tool',
        link: 'https://data.gouv.fr/reuses/paperasse-skills-ia-pour-la-comptabilite-et-fiscalite-francaise',
        code: null
    },
    {
        id: 99,
        category: 'skills',
        icon: '🛠️',
        title: 'skills.sh — Hub de skills agents',
        description: 'Catalogues et installation de skills pour agents IA. Point d\'entrée rapide pour enrichir Claude Code, Codex et autres workflows coding agents.',
        tags: ['skills', 'hub', 'catalog', 'agents'],
        type: 'tool',
        link: 'https://skills.sh/',
        code: 'npx skills init'
    },
    {
        id: 100,
        category: 'tips',
        icon: '🔥',
        title: 'Tendances repérées (sans lien direct)',
        description: 'Dans la veille jointe: mentions récurrentes de <strong>openscreen</strong>, <strong>oh-my-codex</strong> et <strong>claude-howto</strong>. À monitorer pour ajout de fiches dédiées dès URL source stable.',
        tags: ['veille', 'trending', 'todo'],
        type: 'tip',
        link: null,
        code: null
    }
